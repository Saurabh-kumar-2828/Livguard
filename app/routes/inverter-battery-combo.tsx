...
function LandingPage({
    ...
    return (
        <div className="tw-grid tw-grid-rows-1 tw-grid-cols-1 lg:tw-grid-rows-1 lg:tw-grid-cols-[minmax(0,3fr),minmax(0,2fr)] tw-gap-x-1 tw-align-stretch tw-pb-10 lg:tw-pb-20">
            ...
            <WhyLivguardCombo
                userPreferences={userPreferences}
                secondaryNavigationName="b5c93618-db31-4418-add5-a8ed41233d89"
...
export function TvcSection({
    ...
    useEffect(() => {
        secondaryNavigationController.setSections((previousSections) => ({
            ...previousSections,
            "watch-digital-film": {
                humanReadableName: contentData.getContent("b4a80c10-cdab-4fea-9721-e978d67e57d6"),
                isCurrentlyVisible: sectionInView,
            },
        }));
    }, [sectionRef, sectionInView]);
...
export function TapIntoEfficiency({
    ...
    useEffect(() => {
        secondaryNavigationController.setSections((previousSections) => ({
            ...previousSections,
            "battery-combo": {
                humanReadableName: contentData.getContent("a6250469-99cc-440f-a91d-426021ebcaea"),
                isCurrentlyVisible: sectionInView,
            },
        }));
    }, [sectionRef, sectionInView]);
