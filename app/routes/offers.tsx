...
export const loader: LoaderFunction = async ({request}) => {
    ...
    const vernacularData = getVernacularFromBackend("offersPage", userPreferences.language);
    const imageMetaDataLibrary = getImageMetadataLibraryFromBackend("offersPage");
    const ogBanner = getAbsolutePathForRelativePath(getMetadataForImageServerSide("/livguard/offers/offer-og-banner.jpg").finalUrl, ImageCdnProvider.Bunny, 764, null);
...
export default function () {
    const {userPreferences, redirectTo, pageUrl, featuredProducts, vernacularData, imageMetaDataLibrary} = useLoaderData() as LoaderData;
    ...
    return (
        ...
        >
            ...
            <DefaultTextAnimation className="tw-row-start-4 tw-col-start-1 lg:tw-place-self-start lg:tw-col-start-1">
                <div
                    dangerouslySetInnerHTML={{__html: contentData.getContent("dfa03024-6e74-45c6-9634-8d83833930f3")}}
            ...
            <DefaultTextAnimation className="tw-row-start-6 tw-col-start-1 lg:tw-place-self-start lg:tw-max-w-[620px] lg:tw-col-start-1">
                <div
                    dangerouslySetInnerHTML={{__html: contentData.getContent("0931e2ce-74c8-49b3-84d0-760b290166eb")}}
...
export function BestOffers({
    ...
    useEffect(() => {
        secondaryNavigationController.setSections((previousSections) => ({
            ...previousSections,
            "best-offers": {
                humanReadableName: contentData.getContent("c7712522-8ed0-4081-b015-bad7c20015a1"),
                isCurrentlyVisible: sectionInView,
            },
        }));
    }, [sectionRef, sectionInView]);
    ...
    return (
        ...
        >
            <h2 className="lg-px-screen-edge lg-text-headline tw-text-center tw-row-start-1 tw-col-start-1 tw-col-span-full lg:tw-row-start-1 lg:tw-col-start-1 lg:tw-col-span-full">
                <DefaultTextAnimation>
                    <div dangerouslySetInnerHTML={{__html: appendSpaceToString(contentData.getContent("28d2dcd2-f0a8-4314-b3d0-981ddf2444b9"))}} />
                </DefaultTextAnimation>
                <DefaultTextAnimation>
                    <div dangerouslySetInnerHTML={{__html: contentData.getContent("5b7f29b4-216f-4c13-ac5d-811cc4cb1733")}} />
                </DefaultTextAnimation>
            </h2>
                    ...
                    itemBuilder={(item, itemIndex) => (
                        ...
                        >
                            ...
                            <div className="lg-text-icon tw-text-center">
                                {contentData.getContent(item.title)} ({offers[itemIndex][0].offers.length})
                            </div>
                        </button>
                    )}
                />
            ...
            >
                <div className="tw-grid tw-grid-flow-col tw-auto-cols-[100%]">
                    {offers[selectedCategoryIndex][0].offers.length === 0 ? (
                        <EmptyOfferCard
                            userPreferences={userPreferences}
                            buttonText={contentData.getContent(offers[selectedCategoryIndex][0].emptyOfferButtonTextPiece)}
        ...
        >
            <div className="tw-grid tw-grid-cols-1">
                <h2 className="lg-text-headline tw-text-center">
                    <div dangerouslySetInnerHTML={{__html: contentData.getContent("5ac20616-07fb-44f4-bf6f-c5e16b272eb8")}} />
                </h2>
            ...
            <div className="tw-p-4 tw-grid tw-grid-flow-row tw-grid-rows-[repeat(6,auto)_minmax(0,1fr)_repeat(4,auto)]">
                ...
                <div className="tw-w-full tw-text-center lg-text-secondary-700 tw-row-start-8">
                    {price == null
                        ...
                        : `${contentData.getContent("abce92ec-fd9a-4578-ab56-ddfd9fdafe72")}${price}${contentData.getContent("0044b486-6eca-4e3a-abf0-102eede6e10c", userPreferences.language)}`}
                </div>

                <VerticalSpacer className="tw-h-4 tw-row-start-10" />

                <button className="lg-cta-button-product-card tw-w-full tw-text-center tw-px-1 tw-row-start-11">{contentData.getContent("042883e9-36eb-4803-ae55-4a0e495a8752")}</button>
            </div>
        </Link>
    );
}
    ...
    return (
        <div className="tw-w-full tw-h-full tw-min-h-[8rem] tw-grid tw-grid-cols-1 lg:tw-grid-cols-2 lg:tw-grid-rows-[minmax(0,5fr)_2rem_auto_minmax(0,1fr)] tw-justify-items-center tw-items-start lg:tw-place-items-center">
            ...
            <div className="lg:tw-row-start-3 tw-grid tw-grid-flow-row tw-col-span-2 tw-place-items-center tw-place-content-center">
                <div className="tw-text-center lg-text-title1">{contentData.getContent("3b44dc3a-1029-454b-ab4f-748b8cf16a8a")}</div>

                <VerticalSpacer className="tw-h-1" />

                <div className="tw-text-center lg-text-body !lg-text-secondary-900">{contentData.getContent("e4b32997-8139-4b74-8508-0b3ee57977a2")}</div>
        ...
        <div className={concatenateNonNullStringsWithSpaces("tw-w-full tw-grid tw-grid-cols-1 lg:tw-grid-cols-[minmax(0,1fr)_auto] tw-gap-x-2 lg-card tw-rounded-lg", className)}>
            ...
            {/* <div className="tw-text-center lg:tw-col-span-2 lg:tw-pl-2">
                {userPreferences.language === Language.Hindi ? (
                    <>
                        {contentData.getContent("f0453469-c11f-46c4-b462-ad4445abfc46")}
                        {offer.validTill}
                        {contentData.getContent("df574a28-5854-4ceb-a9ec-9bfe5dec1b17")}
                    </>
                ) : (
                    <>
                        {contentData.getContent("f0453469-c11f-46c4-b462-ad4445abfc46")}
            ...
            >
                {contentData.getContent("4d53d9a4-bbd6-464b-be5c-f0bab1defe02")}
            </button>
