...
export default function LivguardDialog({
    ...
    return (
        ...
        >
            <Dialog
                as="div"
                className="tw-relative tw-z-[70] tw-isolate"
            ...
            >
                ...
                <Dialog.Panel className="lg-px-screen-edge tw-py-[var(--lg-px-screen-edge)] lg:tw-py-[1.5rem] tw-fixed tw-inset-0 tw-grid tw-grid-rows-1 tw-grid-cols-1 tw-place-items-center">
                    <Transition.Child
                        as="div"
                        className="tw-w-full tw-pt-[1.5rem] tw-max-w-[23rem] tw-max-h-full tw-bg-secondary-100-light dark:tw-from-secondary-500-dark dark:tw-to-secondary-100-dark lg-bg-secondary-100 tw-px-6 tw-py-6 tw-rounded-lg tw-flex tw-flex-col lg-secondary-700-scrollbar tw-relative"
                        enter="tw-ease-out tw-transition-all tw-duration-200"
                        enterFrom="tw-opacity-0"
                    ...
                    >
                        ...
                        {showCloseIcon && (
                            <button
                                ...
                                className="tw-bg-secondary-100-light dark:tw-from-secondary-500-dark dark:tw-to-secondary-100-dark lg-bg-secondary-100 tw-rounded-full tw-absolute tw-top-2 tw-right-2 lg-card"
                            >
                        ...
                        {title == null ? null : (
                            <>
                                <div className="tw-row-start-1 tw-col-start-2 tw-flex-1 tw-text-center lg-text-title2 tw-px-8">{title}</div>
