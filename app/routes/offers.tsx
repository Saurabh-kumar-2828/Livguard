...
function FeaturedProducts({userPreferences, className}: {userPreferences: UserPreferences; className?: string}) {
    const featuredProducts = [
        ...
        {
            type: ProductType.inverter,
            name: "8b0f4c66-acde-442e-84b2-f73479b94b8b",
        ...
        {
            type: ProductType.inverter,
            name: "e2bd393e-eae8-4746-b5e2-2ec4da81e734",
        ...
        {
            type: ProductType.battery,
            name: "2cac1604-155d-4a6a-950b-e33233842875",
        ...
        {
            type: ProductType.battery,
            name: "1b97fd62-2934-44ca-8665-fd0471d099b1",
