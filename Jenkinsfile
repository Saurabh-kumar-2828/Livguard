                ...
                script {
                    if (env.BRANCH_NAME == 'staging') {
                        ...
                        sshagent(['f74f1a2f-5c3d-49e4-a0e5-646f8d9e87ea']) {
                            ...
                            sh """ssh -o StrictHostKeyChecking=no ubuntu@ec2-15-206-25-181.ap-south-1.compute.amazonaws.com 'sudo /home/ubuntu/livguard-prod-deployment/livguard-deployment.sh'"""
