        ...
        <div className="tw-rounded-lg tw-h-full lg:tw-max-w-4xl tw-grid tw-place-self-center tw-items-center tw-justify-center tw-auto-rows-max lg:tw-grid-rows-1 lg:tw-grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg-bg-secondary-100 max-lg:tw-py-4 max-lg:tw-px-6">
            <div className="tw-rounded-lg tw-row-start-1 lg:tw-col-start-1 tw-grid tw-grid-flow-row tw-grid-rows-1 lg:tw-grid-rows-[repeat(3,auto)_minmax(0,1fr)] tw-h-full lg:tw-p-6 max-lg:tw-text-center">
                <div
                    ...
                    dangerouslySetInnerHTML={{__html: contentData.getContent("6b3b89fd-ba28-481a-86ee-8932e25ef249")}}
                />
                <div
                    ...
                    dangerouslySetInnerHTML={{__html: contentData.getContent("9d0d2fb1-93ce-40e7-ae8a-afd396c7159f")}}
                />
            ...
            <div className="tw-row-start-2 lg:tw-row-start-1 lg:tw-col-start-2 tw-grid tw-grid-flow-row lg:tw-auto-rows-max tw-py-4 lg:lg-bg-new-background-border-500 tw-rounded-lg lg:tw-p-6 tw-h-full">
                <VerticalSpacer className="lg:tw-h-6" />

                <div className="lg-text-title1 tw-text-secondary-900-light dark:tw-text-secondary-900-dark max-lg:tw-text-center">{contentData.getContent("011c1d97-5ae2-4392-b789-a422bc75b9ee")}</div>

                <VerticalSpacer className="lg:tw-h-2" />

                <div
                    className="lg-text-body max-lg:tw-text-center"
                    dangerouslySetInnerHTML={{__html: contentData.getContent("773cc962-c03e-4643-9f7b-bb9d6eeab67b")}}
                />
                ...
                >
                    ...
                    <div className="tw-absolute -tw-top-6 tw-right-4">
                        {!isCodeCopied
                            ? contentData.getContent("a71eedc4-b0f8-46b3-88d1-c7427315de8c")
                            : contentData.getContent("eee1a98d-b9ab-4ee5-bde6-bcb2cdc26ece")}
                    </div>
                    <button
                ...
                <div className="tw-grid tw-grid-flow-col tw-grid-cols-[max-content_auto] tw-gap-x-3">
                    ...
                    <div>{contentData.getContent("10f2f51f-a177-48ec-be50-990650be4f59")}</div>
                </div> */}

                <VerticalSpacer className="tw-h-10 md:tw-h-12" />

                <div
                    className="tw-place-self-center"
                    dangerouslySetInnerHTML={{__html: contentData.getContent("e8190da2-de31-41e3-a749-f3e77acc2807")}}
                />
                ...
                >
                    {contentData.getContent("bc3184f6-0f40-4633-bca8-1e9c2c21852a")}
                </button>
